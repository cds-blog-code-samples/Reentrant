  ...
  actions: [
    {
      ...
      kind: 'function',
      isDelegate: false,
      functionName: 'testLocalCallGuarded',
      contractName: 'TestGuard',
      arguments: [],
      actions: [
        {
          type: 'callexternal',
          address: '0x2fd186B13661e8bC5c7B70196327d34AafB0e889',
          contextHash: '0xea03f31f76704c0438f028769292d7ff4c46e41eac0dfefd297df79ffaffe496',
          value: <BN: 0>,
          kind: 'function',
          isDelegate: false,
          functionName: 'countThisRecursive',
              ...
              arguments: [
                ...
                },
                {
                  ...
                  value: {
                    ...
                    value: {
                      kind: 'valid',
                      asString: 'counter got tickled to 2'
                    }
                  }
                }
              ],
          ...
          arguments: [
            ...
            },
            {
              ...
              value: {
                ...
                kind: 'value',
                value: { kind: 'valid', asString: 'counter got tickled to 2' }
              }
            }
          ],
          returnKind: 'return',
